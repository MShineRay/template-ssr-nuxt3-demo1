export default [
  ...
  },
  {
    ...
    keywords: '全局路由中间件',
    description:
      '全局路由中间件配置后会在项目所有导航前执行此配置文件中的逻辑，以决定是继续、异常还是导航到新页面。',
  },
  {
  ...
  },
  {
    ...
    keywords: '编程式导航',
    description:
      '通过路由器助手函数，允许通过Nuxt应用程序以编程方式导航，支持内部路由和跳转到外部网址。',
  },
  {
    url: '/transition/page',
  ...
  },
  {
    ...
    keywords: 'AntD插',
    description:
      'ant-design-vue（简称antd）为 Web 应用提供了丰富的基础 UI 组件，并持续探索企业级应用的最佳 UI 实践。',
  },
  {
  ...
  },
  {
    ...
    keywords: 'SEO',
    description:
      'SEO（Search Engine Optimization）即搜索引擎优化，利用搜索引擎的规则提高网站在有关搜索引擎内的自然排名。',
  },
  {
    url: '/seo/base',
    ...
    description:
      'Nuxt3提供Title等组件化SEO和useHead等编程化SEO以便可以在模板或JS中直接与SEO元数据交互。',
  },
  {
    url: '/more/theme',
  ...
  },
  {
    ...
    keywords: 'color-mode',
    description:
      'Nuxt3提供了一个模块系统来扩展框架核心并简化集成，使用color-mode（自动检测和切换深色模式的Nuxt3模块）为例。',
  },
  {
